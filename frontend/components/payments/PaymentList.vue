  ...
  &lt;div class="space-y-4">
    ...
    &lt;div class="bg-white shadow overflow-hidden sm:rounded-md">
      &lt;ul v-if="payments.length > 0" class="divide-y divide-gray-200">
        &lt;li v-for="payment in payments" :key="payment.id" class="hover:bg-gray-50">
              ...
              &lt;div class="sm:flex">
                &lt;p class="flex items-center text-sm text-gray-500">
                  &lt;svg class="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    />
                  &lt;/svg>
                  {{ payment.client?.name || 'Cliente não especificado' }}
                &lt;/p>
                &lt;p v-if="payment.task" class="mt-2 flex items-center text-sm text-gray-500 sm:mt-0 sm:ml-6">
                  &lt;svg class="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    &lt;path
                      stroke-linecap="round"
                      stroke-linejoin="round"
...
defineEmits<{
  (e: 'add'): void
  (e: 'edit', payment: any): void
  (e: 'delete', payment: any): void
